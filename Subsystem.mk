...
## Generated on : Sun Nov 28 16:52:19 2021
...
START_DIR                 = C:/Users/MANMAT~1/OneDrive/DOCUME~1/MATLAB/7146_C~1/28NOV2~2/CRZCNTRL
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Subsystem_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Subsystem -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Subsystem_grt_rtw/Subsystem.c
...
%.obj : $(START_DIR)/Subsystem_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
Subsystem.obj : $(START_DIR)/Subsystem_grt_rtw/Subsystem.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
